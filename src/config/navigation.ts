...
export const NAV = {
  ...
  industries: {
    ...
    intro: {
      ...
      description:
        "Sector-specific freight execution for industrial, retail, manufacturing, and specialized supply chains.",
    ...
    links: [
      {
        ...
        description: "Heavy materials handled with engineered securement and compliance rigor.",
        icon: "shield",
      },
      {
        label: "Manufacturing",
        href: "/industries/manufacturing-materials",
        description: "Production-critical freight planning for stable throughput.",
        icon: "package",
      },
      {
        label: "Automotive",
        href: "/industries/automotive",
        description: "Vehicle and component movements with sequencing precision.",
        icon: "truck",
      },
      {
        label: "Construction",
        href: "/industries/industrial-energy",
        description: "Project cargo support for industrial and construction supply chains.",
        icon: "building",
      },
      {
        label: "Retail",
        href: "/industries/retail-consumer-goods",
        description: "Replenishment lanes managed against service-level commitments.",
        icon: "warehouse",
      },
      {
        label: "Food & Beverage",
        href: "/industries/food-beverage",
        description: "Temperature-aware execution to protect freshness and quality windows.",
        icon: "snowflake",
      },
      {
        label: "Industrial Equipment",
        href: "/industries/industrial-energy",
        description: "Specialized handling for machinery and industrial systems.",
        icon: "briefcase",
      },
      {
        label: "Energy",
        href: "/industries/industrial-energy",
        description: "Safety-led movement across energy-related freight programs.",
        icon: "globe",
      },
      {
        label: "Time-Critical Freight",
        href: "/solutions/expedited",
        description: "Expedited freight options for urgent industrial timelines.",
        icon: "zap",
      },
    ],
  ...
  company: {
    ...
    links: [
      ...
      {
        label: "Our Companies",
        href: "/company/our-companies",
        description: "The operating companies and capabilities across the SSP group.",
        icon: "building",
      },
      {
        label: "Coverage & Network",
        href: "/company/coverage-network",
      ...
      {
        label: "Video Gallery",
        href: "/company/video-gallery",
        description: "Company videos, operations highlights, and media resources.",
        icon: "briefcase",
      },
      {
        label: "FAQs",
      ...
      },
      {
        label: "Contact",
        href: "/contact",
        description: "Connect with our team on your freight priorities.",
        icon: "phone",
      },
    ],
  } satisfies NavSection,
