...
export function AboutSspWhoWeAre({ data }: { data: WhoWeAreData }) {
  ...
  return (
    <section
      ...
      className="relative overflow-hidden scroll-mt-24 border-y border-[color:var(--color-border-light-soft)] py-20 sm:py-24"
      style={{
        background:
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0" aria-hidden>
        <div className="absolute inset-x-0 top-0 h-24 bg-gradient-to-b from-[color:var(--color-company-ink)]/16 to-transparent" />
        <div
      ...
      <div
        ...
        style={{ background: "linear-gradient(90deg, transparent 10%, var(--color-company-section-accent-cyan) 50%, transparent 90%)" }}
        aria-hidden
      />
            ...
            <div className="relative">
              ...
              >
                <div className="relative aspect-[16/10] overflow-hidden rounded-[1.1rem]">
                  <Image
                    src="/_optimized/company/ssp-team-photo.webp"
              ...
              <div className="absolute -right-8 top-[12%] z-20 hidden w-[33%] -rotate-[2deg] rounded-xl border border-[color:var(--color-border-light)] bg-white p-1.5 shadow-[var(--shadow-company-who-float-card)] xl:block">
                <div className="relative aspect-[16/10] overflow-hidden rounded-[0.8rem]">
                  <Image
                    src="/_optimized/company/who-we-are-fleet-lineup-milton.jpg"
                    alt="SSP trucks staged in Milton yard"
                    fill
                    className="object-cover object-center"
                    sizes="24vw"
                  />
                ...
                <p className="px-2.5 pb-1.5 pt-2 text-[10.5px] leading-5 text-[color:var(--color-muted)]">
                  Dedicated fleet readiness from our Milton operations base.
                </p>
              </div>
