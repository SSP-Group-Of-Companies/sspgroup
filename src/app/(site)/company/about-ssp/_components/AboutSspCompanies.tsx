...
export function AboutSspCompanies({ data }: { data: OurCompaniesContent }) {
  ...
  return (
    ...
    >
      {/* Bridge out of Mission / dark band — shared ink, soft fade */}
      <div
      ...
      {/* Echo Mission’s top hairline — single restraint, then nothing */}
      <div
      ...
      {/* Ultra-faint grid: headline column only (whisper, not wallpaper) */}
      <div
