  ...
  return (
    ...
    >
      <div className="pointer-events-none absolute inset-0" aria-hidden>
        <div className="absolute inset-x-0 top-0 h-16 bg-gradient-to-b from-[rgba(8,17,30,0.5)] via-[rgba(8,17,30,0.18)] to-transparent" />
        <div className="absolute inset-0 bg-[radial-gradient(780px_360px_at_14%_8%,rgba(16,167,216,0.05),transparent_62%)]" />
        <div className="absolute inset-0 bg-[radial-gradient(860px_480px_at_90%_100%,rgba(220,38,38,0.05),transparent_56%)]" />
        <div className="absolute inset-y-[16%] left-[28%] w-[34%] bg-[radial-gradient(closest-side,rgba(255,255,255,0.84),rgba(255,255,255,0.18),transparent_82%)] blur-[48px]" />
      </div>
