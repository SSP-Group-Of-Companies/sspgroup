  ...
  return (
    ...
    >
      <div className="pointer-events-none absolute inset-0" aria-hidden>
        <div className="absolute inset-x-0 top-0 h-24 bg-gradient-to-b from-[color:var(--color-surface-2)]/36 via-white/[0.03] to-transparent" />
        ...
        <div className="absolute -left-20 top-[20%] h-[240px] w-[240px] rounded-full bg-[color:var(--color-ssp-cyan-500)]/5 blur-[118px]" />
        <div className="absolute -right-24 bottom-[16%] h-[300px] w-[300px] rounded-full bg-[color:var(--color-brand-500)]/5 blur-[132px]" />
        <div
