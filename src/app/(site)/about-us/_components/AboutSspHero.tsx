...
const PROOF_ITEMS = [
  { value: "Asset-Based", label: "Execution Ownership" },
  { value: "CA • U.S. • Mexico", label: "Operating Footprint" },
  { value: "Founded 2015", label: "Growth With Control" },
] as const;
    ...
    >
      ...
      <Container className="site-page-container relative">
        <motion.div
          ...
          animate="show"
          variants={stagger}
          className="relative z-20 grid items-center gap-8 lg:grid-cols-12 lg:gap-12"
        >
