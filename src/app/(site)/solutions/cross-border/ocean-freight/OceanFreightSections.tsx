      ...
      <Container className="site-page-container relative">
        <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
          ...
          <motion.div
            ...
            transition={{ duration: reduceMotion ? 0 : 0.65, ease: "easeOut", delay: 0.15 }}
        ...
        <motion.div
          ...
          transition={{ duration: reduceMotion ? 0 : 0.55, ease: "easeOut", delay: 0.2 }}
...
export function OceanCardSection({
  ...
  if (layout === "centered") {
    return (
      <section id={id} className={cn("border-y border-[color:var(--color-ocean-400)]/10 bg-[linear-gradient(180deg,#ffffff,var(--color-ocean-50))] py-20 sm:py-24", id && "scroll-mt-24")}>
  ...
  return (
    <section id={id} className={cn("bg-[linear-gradient(180deg,#ffffff,var(--color-ocean-50))] py-20 sm:py-24", id && "scroll-mt-24")}>
      <Container className="site-page-container">
...
export function OceanStepsSection({
  ...
  return (
    <section className="border-y border-[color:var(--color-ocean-400)]/10 bg-[linear-gradient(180deg,var(--color-ocean-50),#ffffff)] py-20 sm:py-24">
      <Container className="site-page-container">
        <motion.div
          className="mx-auto max-w-3xl text-center"
          initial="hidden"
...
export function OceanCtaSection({
  ...
  return (
    <section className="relative overflow-hidden border-t border-[color:var(--color-ssp-ink-800)]/40 bg-[linear-gradient(145deg,var(--color-footer-legal-bg),var(--color-ssp-ink-900)_40%,var(--color-ssp-ink-800))] py-20 sm:py-24">
      <div className="pointer-events-none absolute inset-0" aria-hidden>
        <div className="absolute bottom-[-60px] right-[10%] h-[200px] w-[200px] rounded-full bg-[color:var(--color-ocean-400)]/8 blur-[100px]" />
        <div className="absolute top-[-40px] left-[25%] h-[180px] w-[180px] rounded-full bg-[color:var(--color-ocean-300)]/6 blur-[80px]" />
      </div>
          ...
          <div className="grid gap-7 lg:grid-cols-12 lg:items-center">
            <div className="lg:col-span-8">
              ...
              <div className="mt-5 flex flex-wrap gap-2 text-xs text-white/65">
                {pills.map((p) => (
                  <span
                    key={p}
                    className="rounded-full border border-[color:var(--color-ocean-400)]/22 bg-[color:var(--color-ocean-400)]/8 px-3 py-1"
                  >
                    {p}
                  </span>
                ))}
            ...
            <div className="rounded-xl border border-white/12 bg-white/[0.05] p-4 sm:p-5 lg:col-span-4">
              ...
              <div className="mt-4 grid gap-3">
                <Link
                  href={primaryCta.href}
                  className={cn("inline-flex h-12 items-center justify-center rounded-lg bg-[color:var(--color-ocean-400)] px-5 text-sm font-semibold text-white shadow-[0_6px_20px_rgba(45,139,201,0.35)] transition hover:bg-[color:var(--color-ocean-500)] hover:shadow-[0_10px_28px_rgba(45,139,201,0.45)]", focusRingDark)}
                >
                  {primaryCta.label}
                </Link>
                <Link
