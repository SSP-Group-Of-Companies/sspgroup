...
export function AirCardSection({
  ...
  if (layout === "centered") {
    return (
      <section id={id} className={cn("relative overflow-hidden border-y border-[color:var(--color-air-400)]/10 bg-[linear-gradient(180deg,#ffffff,var(--color-air-50))] py-20 sm:py-24", id && "scroll-mt-24")}>
        <div className="pointer-events-none absolute inset-0" aria-hidden>
          <div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-[color:var(--color-air-400)]/22 to-transparent" />
          <div
  ...
  return (
    <section id={id} className={cn("relative overflow-hidden bg-[linear-gradient(180deg,#ffffff,var(--color-air-50))] py-20 sm:py-24", id && "scroll-mt-24")}>
      <div className="pointer-events-none absolute inset-0" aria-hidden>
        <div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-[color:var(--color-air-400)]/22 to-transparent" />
        <div
          className="absolute left-0 top-0 h-[min(21rem,54vh)] w-full max-w-4xl opacity-[0.038]"
...
export function AirStepsSection({
  ...
  return (
    <section className="relative overflow-hidden border-y border-[color:var(--color-air-400)]/10 bg-[linear-gradient(180deg,var(--color-air-50),#ffffff)] py-20 sm:py-24">
      <div className="pointer-events-none absolute inset-0" aria-hidden>
        <div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-[color:var(--color-air-400)]/22 to-transparent" />
        <div
          className="absolute left-0 top-0 h-[min(21rem,54vh)] w-full max-w-4xl opacity-[0.038]"
...
export function AirCtaSection({
  ...
  return (
    <StandardFinalCta
      variant="corridor"
      headingId="air-freight-final-cta-heading"
      trackingLocation="air_freight_final_cta"
      accentColor="var(--color-air-400)"
      orbMainColor="rgba(91,155,229,0.3)"
      orbSecondaryColor="rgba(130,181,238,0.14)"
      eyebrow={<AirEyebrow label={eyebrow} light />}
      data={{
        kicker: eyebrow,
        title,
        body: description,
