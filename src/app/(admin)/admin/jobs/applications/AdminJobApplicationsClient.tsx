...
export default function AdminJobApplicationsClient({
  ...
  const filters = useAdminUrlSyncedFilters("/admin/jobs/applications");
      ...
      <AdminListFilterCard>
        <div className="p-5">
          <AdminListPageHeader
            ...
            description="Review applicants and track status."
          />
                        ...
                        {slug ? (
                          <a
                            ...
                            className={cn(
                              ...
                              "text-[var(--dash-text)] hover:decoration-[var(--dash-accent-soft)]",
